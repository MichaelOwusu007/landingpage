    ...
    <main className='w-full flex-1 mx-auto p-2 -z-10 overflow-hidden'>
      ...
      <section className=' scroll-m-[150px] py-16' id='Overview'>
        <div className='scroll-m-[50px] overview'>
          <div className=' flex flex-col lg:flex-row items-center justify-between lg:gap-20 gap-14 false '>
            <div data-aos="zoom-in" className=' relative w-full sm:w-[65%]  lg:w-[40%] '>
              <img src='/img/the-big-idea-1.png'/>
            </div>
            <div data-aos="zoom-in" className=' w-full lg:w-[50%] relative lg:text-start text-center '>
        ...
        <div className=' lg:py-20 my-6 scroll-m-[50px] overview '>
          <div className=' flex flex-col lg:flex-row items-center justify-between gap-14 lg:gap-20 '>
            <div className=' relative lg:w-[40%] space-y-10 lg:text-start text-center max-w-[750px] '>
              <img data-aos="zoom-in" src='/img/sata-gra.png' className=' absolute -top-14 left-14 w-[30px] ' />
              <h2 data-aos="zoom-in" className=' font-bold text-[40px] '>
                Frequently Asked
                <br />
      ...
      <section className='relative scroll-m-[150px] py-20  ' id='Timeline'>
        <div className='max-w-[1400px] mx-auto '>
          <div data-aos="zoom-in" className='text-center space-y-4 lg:space-y-6 '>
          ...
          <div className='py-2 lg:py-10 w-full mx-auto my-4 lg:my-6'>
            <div className=' space-y-4 px-6 md:px-10 lg:px-4 '>
              <div className=' xl:flex hidden lg:gap-6 xl:gap-20 items-end flex-row'>
                <div data-aos="zoom-in" className=' py-4 text-end flex-1'>
                ...
                <div data-aos="zoom-in" className=' w-[100px] h-max gap-4 flex flex-col items-center justify-center'>
                ...
                <div data-aos="zoom-in" className=' py-4 flex-1  '>
              ...
              <div className='flex xl:hidden gap-2 md:gap-4'>
                <div data-aos="zoom-in" className='w-max lg:w-[100px] gap-2 lg:gap-4 flex flex-col justify-between items-center'>
                ...
                <div className='flex flex-col justify-between py-1 md:py-2 flex-1'>
                  ...
                  <h3 data-aos="zoom-in" className="text-pink-500 font-bold text-[17px] lg:text-[22px] ">november 18,2023</h3>
                </div>
              </div>
              <div className=' xl:flex hidden lg:gap-6 xl:gap-20 items-end flex-row-reverse'>
                <div data-aos="zoom-in" className=' py-4 text-start flex-1 '>
              ...
              <div className='flex xl:hidden gap-2 md:gap-4'>
                ...
                <div className='flex flex-col justify-between py-1 md:py-2 flex-1'>
                  ...
                  <h3 data-aos="zoom-in" className="text-pink-500 font-bold text-[17px] lg:text-[22px] ">november 20,2023</h3>
                </div>
              </div>
              <div className=' xl:flex hidden lg:gap-6 xl:gap-20 items-end flex-row'>
                <div data-aos="zoom-in" className=' py-4 text-end flex-1'>
              ...
              <div className=' xl:flex hidden lg:gap-6 xl:gap-20 items-end flex-row-reverse'>
                ...
                <div className=' w-[100px] h-max gap-4 flex flex-col items-center justify-center'>
                  <div data-aos="zoom-in" className=' min-h-[100px] bg-pink-500 w-[3px] '></div>
              ...
              <div className='flex xl:hidden gap-2 md:gap-4'>
                ...
                <div className='flex flex-col justify-between py-1 md:py-2 flex-1'>
                  ...
                  <h3 data-aos="zoom-in" className="text-pink-500 font-bold text-[17px] lg:text-[22px] ">november 22,2023</h3>
                </div>
              </div>
              <div className=' xl:flex hidden lg:gap-6 xl:gap-20 items-end flex-row'>
                <div data-aos="zoom-in" className=' py-4 text-end flex-1'>
              ...
              <div className='flex xl:hidden gap-2 md:gap-4'>
                ...
                <div className='flex flex-col justify-between py-1 md:py-2 flex-1'>
                  ...
                  <h3 data-aos="zoom-in" className="text-pink-500 font-bold text-[17px] lg:text-[22px] ">november 23,2023</h3>
                </div>
              </div>
              <div className=' xl:flex hidden lg:gap-6 xl:gap-20 items-end flex-row-reverse'>
                <div data-aos="zoom-in" className=' py-4 text-start flex-1'>
              ...
              <div className='flex xl:hidden gap-2 md:gap-4'>
                ...
                <div className='flex flex-col justify-between py-1 md:py-2 flex-1'>
                  ...
                  <h3 data-aos="zoom-in" className="text-pink-500 font-bold text-[17px] lg:text-[22px] ">november 24,2023</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="py-20 my-6 scroll-m-[50px] overview ">
          ...
          <div className="flex flex-col lg:flex-row items-center false gap-14 lg:gap-20 justify-between ">
            <div data-aos="zoom-in" className="relative w-full sm:w-[65%] lg:w-[40%] ">
              ...
              <img src='/img/star.png' className=' absolute w-[20px] -bottom-[50px] left-[30%] '/>
            </div>
            <div className=" awards flex justify-center items center w-full lg:w-[50%] ">
              <div className=' award flex mt-4 lg:mt-10 space-x-2 max-w-[550px] '>
                <div data-aos="zoom-in" className='welldone rounded bg-[rgba(212,52,254,0.12)] w-[130px] h-[230px] xl:w-[150px] xl:h-[250px] flex items-center flex-col space-y-3 border-[1px] border-[#D434FE]'>
                  <img src='/img/bronze-medal-1.png' className='w-[120px] h-[120px] ' />
                  <h3>2nd</h3>
                  <h2>N400,000</h2>
                </div>
                <div data-aos="zoom-in" className='winner rounded bg-[rgba(212,52,254,0.12)] w-[155px] h-[260px]  xl:w-[180px] xl:h-[280px] flex items-center flex-col space-y-3 border-[1px] border-[#903AFF] '>
      ...
      <section className=' relative py-20'>
        ...
        <div className=' scroll-m-[50px] overview'>
          <div className=' text-center space-y-4 '>
            <h2 data-aos="zoom-in" className='text-[32px] font-bold '>Partners and Sponsers </h2>
            <p data-aos="zoom-in">
          ...
          <div data-aos="zoom-in" className=' flex relative items-center justify-center my-20'>
        ...
        <div className='py-10 lg:py-20 scroll-m-[50px] overview '>
          <div className=' flex flex-col lg:flex-row items-center false gap-14 lg:gap-20 justify-between'>
            <div className='relative w-full lg:w-[45%] '>
              <div data-aos="zoom-in" className='space-y-6 pb-6'>
              ...
              <div className=' bg-zinc-300 bg-opacity-5 flex flex-col space-y-4 items-center rounded-[5px] py-10 px-4 lg:p-10 '>
                <p data-aos="zoom-in" className=' pb-6'>
                ...
                <h3 data-aos="zoom-in" className=' text-pink-500   font-bold w-full'>Licensing Policy</h3>
                <p data-aos="zoom-in" className='font-bold w-full'>
                  Here are terms of our standard License:
                </p>
                <ul className=' space-y-6'>
                  <li className='flex gap-3 items-start'>
                    {/*svg */}
                    <p data-aos="zoom-in" className=' break-words'>
            ...
            <div data-aos="zoom-in" className=' relative w-full px-6 pt-10 lg:w-[40%] sm:w-[65%] '>
